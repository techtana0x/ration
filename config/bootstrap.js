...
module.exports.bootstrap = async function() {
  ...
  var matt = await User.create({
    emailAddress: 'mhaitana@gmail.com',
    fullName: 'Matt Haitana',
    password: await sails.helpers.passwords.hashPassword('abc123')
  }).fetch();

  await Thing.createEach([
    { label: 'Sewing Machine', user: ryan.id },
  ...
  // await User.addToCollection(ryan.id, 'friends', matt.id);
